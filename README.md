...
### Poor OCR Results / Incorrect Data
**Possible causes**:
- Screen resolution issues - ensure OCR region is correctly positioned
- Screen scaling settings - try 100% scaling in Windows display settings
- InfoVotantes application UI has changed - OCR region may need adjustment
